...
from preprocess.parse_csv import parse_admission, parse_diagnoses, parse_notes, parse_patients
...
from preprocess.build_dataset import split_patients, build_patient_data, build_disease_y
...
if __name__ == '__main__':
    ...
    other_path = os.path.join(data_path, 'mimic3', 'other')
